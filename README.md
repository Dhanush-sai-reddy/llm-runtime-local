...
- [graphrag-langextract-vllm/](https://github.com/Dhanush-sai-reddy/llm-runtime-local/tree/main/graphrag-langextract-vllm) --An implementation of GraphRAG with help of langextract library and vLLM.
